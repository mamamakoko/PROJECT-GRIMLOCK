...
Features
1. Attendance Recording: Automatically record attendance of the students
2. Attendance Monitoring: Real-time updates of attendance.
3. Emergency response: Automatically unlocks the door when seismic and smoke is detected.
...
- The .ino file named GRIMLOCK_v4.1 containes the general code for the door lock. While the GRIMLOCK_v4.1.1 containes the code for the accelerometer, and smoke sensor.
- Update the IP addresses in the GRIMLOCK_v4.1.ino
...
- For the other controller, upload the GRIMLOCK_v4.1.1.
...
Challenges Faced
1. The network connection may not be stable sometimes.
2. MFRC522 may not also be stable when the wire used is rusted.

Solutions
1. An external reset button was added so the microcontroller could refresh and restart the connection.
2. Ensured proper and good condition of wire used.
3. Future Improvements
4. Add proper wiring to the device.
5. Instead of using MFRC522, use the NFC reader and let the desktop application handle the RFID card.
